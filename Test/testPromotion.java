...
public class testPromotion
{
    ...
    void testToString()
    {
        ...
        assertEquals("La promotion contient 2 étudiant(s)\nVoici la liste des étudiants : \nNom : Bob, Date de naissance : 12/05/2000, Moyenne : 13.0\nNom : Alice, Date de naissance : 26/11/1999, Moyenne : 17.0", promotion2.toString(), "Erreur sur la récupération en text de la promotion 2");
    }
